...
For each laryCommentsID in Request.Form("chkCommentsNo")
	...
	strSQL = "DELETE FROM tblComments WHERE tblComments.Comment_ID =" & CLng(laryCommentsID) & ";"
...
'Return to the Select Journal Item page
Response.Redirect "delete_journal_comments_form.asp?JournalID=" & Request.Form("JournalID")
%>
