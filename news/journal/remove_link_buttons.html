...
<div align="center"> 
 <p><a href="admin_menu.asp" target="_self"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Return to the the Administration Menu</font></a><br>
  ...
  <br>
  <font face="Verdana, Arial, Helvetica, sans-serif" size="2">Thank-you for your donation to Web Wiz Guide, the links should now be removed from the Site Journal.<br>
  <br>
  ...
  <% Else %>
  <br>
  <font face="Verdana, Arial, Helvetica, sans-serif" size="2">As part of the license for the Web Wiz Site Journal you are required to leave Powered By<br>
  ...
  ongoing time that have gone into the development and support of the Journal.<br>
  <br>
  ...
  <br>
  <a href="http://www.webwizguide.info/donations/default.asp" target="_blank">Click here to make a donation to Web Wiz Guide and receive the link removal code</a> <br>
  </font><br>
 </p>
 </div>
<%
