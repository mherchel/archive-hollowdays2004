...
<title>Remove Mailing List Members</title>
...
<body bgcolor="#FFFFFF">
<div align="center"> <font size="6"><b>Remove Mailing List Members</b></font><br>
  <a href="admin_menu.asp" target="_self">Return to the Mailing List menu Menu</a>
...
Else
	...
	Response.Write vbCrLf & "	      Place a tick in the check box of the e-mail address you wish to remove<br><br>"
	Response.Write vbCrLf & "	      There are " & intTotalNumEntries & " mailing list members in " & intTotalNumPages & " pages and your are on page number " & intRecordPositionPageNum
...
<br>
    <table width="90%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"> <b>Check Box's to delete Mailing List Members</b> 
          <br>
          <input type="submit" name="cmdDelete" value="Delete Selected Entries">
        </td>
      </tr>
    </table>
    <br>
