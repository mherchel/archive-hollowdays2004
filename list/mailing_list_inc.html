...
strMailingListAccessDB = "mailing_list/hdmailing_list.mdb"
...
<form name="frmMailingList" method="post" action="<% = strMailingListPath %>mailing_list.asp" target="mailingList" onSubmit="window.open('', 'mailingList', 'toolbar=0,location=0,status=0,menubar=0,scrollbars=0,resizable=1,width=400,height=200')">
  <table width="143" border="0" align="center" cellpadding="0" cellspacing="2" class="13text">
    <!--DWLayoutTable-->
    <tr> 
      <td height="15" colspan="4" class="text"><div align="center">Your E-mail 
          Address:</div></td>
    </tr>
    <tr> 
      <td height="37" colspan="4"> <input type="text" name="email" class="listcontact" maxlength="35"> 
      </td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td height="24">&nbsp;</td>
      <td width="25">&nbsp;</td>
      <td width="74" align="center" valign="top"> <div align="left"> 
